public class ErrorLog {
    ...
    public boolean containsKey(String keyword){  
        int index = description.indexOf(keyword);
            if (index != -1) {
                boolean isAtStart = index == 0 || description.charAt(index - 1) == ' ';
                boolean isAtEnd = index + keyword.length() == description.length() || description.charAt(index + keyword.length()) == ' ';
